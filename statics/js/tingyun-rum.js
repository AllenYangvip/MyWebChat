window._ty_rum && window._ty_rum.server || function(t) {
		...
		switch(typeof t) {
			case "object":
				...
				if(t instanceof Array) {
					for(var e = "[", n = 0; n < t.length; n++) e += (n > 0 ? "," : "") + r(t[n]);
					return e + "]"
				}
				var e = "{",
					n = 0;
		...
		if("function" == typeof o) {
			switch(o.length) {
				...
				case 5:
					...
					break;
				default:
					for(var i = [], s = 0, u = o.length; u > s; s++) i.push("_" + s);
		...
		if(0 != e.length) {
			if("string" == typeof r) {
				...
				if(o[1] = r.message || (r.error && r.error.constructor.name) + (r.error && r.error.message) || "", o[2] = r.lineno ? r.lineno : 0, o[3] = r.colno ? r.colno : 0, o[4] = r.filename || r.error && r.error.fileName || r.target && r.target.baseURI || "", o[4] == x.URL && (o[4] = "#"), r.error) {
					...
					o[7] = j[s] ? 0 : 1, j[s] = !0
				} else o[5] = null, o[6] = null, o[7] = 0;
				if(o[1] === a && o[4] === a) return;
				g(o)
			}
			U.errors.push(o)
		}
	...
	function b(r) {
		return function() {
			function e(t) {
				var r, e, a = p._ty_rum;
				if(a) {
					if(4 !== a.readyState && (a.end = n()), a.s = p.status, "" == p.responseType || "text" == p.responseType) a.res = T(p.responseText);
					...
					if(a.readyState = p.readyState, a.cb_time = d, r = [a.method + " " + a.url, a.s > 0 ? a.end - a.start : 0, d, a.s, a.s > 0 ? 0 : t, a.res, a.req], a.r && (e = i(p), e && (e = e.xData) && (r.push(e.id), r.push(e.action), r.push(e.time && e.time.duration), r.push(e.time && e.time.qu))), D.aa.push(r), D.server.custom_urls && D.server.custom_urls.length && !U.ct) {
						if(!D.pattern) {
							D.pattern = [];
							for(var s = 0; s < D.server.custom_urls.length; s++) D.pattern.push(new RegExp(D.server.custom_urls[s]))
						}
	...
	var E, k = t.XMLHttpRequest,
		...
		N = {
			...
			GET: function(t, r) {
				...
				if(navigator && navigator.sendBeacon && M.test(t)) return navigator.sendBeacon(t, null);
			...
			POST: function(r, e, n, a) {
				...
				var i;
				if(t.XDomainRequest) return i = new XDomainRequest, i.open("POST", r), i.onload = function() {
	...
	if(D.server && !(D.server.sr && Math.random() >= D.server.sr)) {
		...
		for(var U = D.metric = {
				...
				send: function() {
					...
					function o(t) {
						...
						if(n && n.getEntriesByType) {
							...
							if(U.errors.length) {
								o.err = [];
								for(var c = 0, d = U.errors, h = d.length; h > c; c++) o.err.push({
					...
					var f = N.bind(p, this);
					return f(), setInterval(f, 1e4), this.sended = !0, this.sa(1), !0
				},
				sa: function(t) {
				...
				["pagehide", y],
				["unload", y]
			], J = 0; J < z.length; J++) N.sh(t, z[J][0], z[J][1], !1);
